...
public class UT extends CustomCard implements ModHelper {
    public static final String ID = "ninjagaiden4:UT";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "lingqiu1700/ninjagaiden4/images/cards/attack/UT.png";
